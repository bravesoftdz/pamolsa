...
const ProductsBySearch = ({match}) => {
    ...
    const apiGetSearch = async () => {
        const response = await Axios.get(`http://pmls.tk/api/product/find/query?query=${nameFilter}`);
        setProductsFilter(response.data.data)
        console.log(response.data.data)
    }

    const apiGetLines = async () => {
        const response = await Axios.get(`http://pmls.tk/api/product/line/list?business=${business_id}`);
        setLines(response.data.data)
    }

    const apiGetTypes = async () => {
        const response = await Axios.get(`http://pmls.tk/api/product/types/list?business=${business_id}`);
        setTypes(response.data.data)
    }

    const apiGetMaterial = async () => {
        const response = await Axios.get(`http://pmls.tk/api/product/material/list?business=${business_id}`);
