...
const Postulation = () => {
    ...
    const apiDepartments = async () => {
        const response = await axios.get('http://pmls.tk/api/department/list');
        setDepartments(response.data.data)
    }

    const apiProvinces = async () => {
        const response = await axios.get('http://pmls.tk/api/province/list');
        setProvinces(response.data.data)
    }

    const apiDistricts = async () => {
        const response = await axios.get('http://pmls.tk/api/district/list');
